  ...
  return (
    <div className="page-scroll flex h-full w-full justify-center bg-bg px-6 py-8 text-ink">
      <div className="w-full max-w-[840px]">
        ...
        <div className="mb-6 space-y-4 border-b border-line pb-4">
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  placeholder="Filtrar..."
                  className="h-8 w-44 rounded-lg border border-line bg-panel pl-8 pr-2 text-xs text-ink outline-none transition-colors focus:border-red-500/60 placeholder:text-faint"
                />
                {searchQuery && (
                  <button
                    type="button"
          ...
          <div className="flex flex-wrap items-center gap-1.5 pt-1">
            ...
            >
              <Calendar size={14} />
              <span>Hoje</span>
              <span className="ml-0.5 rounded-full bg-red-500/20 px-1.5 py-0.2 text-[10px] font-bold text-red-500">
        ...
        {overdueCount > 0 && (
          <div className="mb-6 rounded-xl border border-red-500/30 bg-red-500/5 p-4">
            <div className="mb-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-red-500">Atrasada</span>
        ...
        <div className="mb-6 rounded-xl border border-line bg-panel p-3 shadow-sm transition-all focus-within:border-red-500/60 focus-within:ring-1 focus-within:ring-red-500/30">
          <input
            ref={inputRef}
            type="text"
            value={inputValue}
          ...
          {(parsedPreview.dueDateLabel || parsedPreview.tags.length > 0) && (
            <div className="mt-2.5 flex items-center gap-2 border-t border-line/60 pt-2">
              ...
              {parsedPreview.dueDateLabel && (
                <span className="inline-flex items-center gap-1 rounded-md bg-red-500/10 px-2 py-0.5 text-[11px] font-medium text-red-500">
          ...
          <div className="mt-2 flex items-center justify-between pt-1">
            ...
            <Button
              ...
              className="bg-red-500 text-white hover:bg-red-600 shrink-0 text-xs font-semibold"
            >
      ...
      <button
        ...
        className={`mt-0.5 grid h-[18px] w-[18px] shrink-0 place-items-center rounded-full border-2 transition-all ${
          todo.done
            ...
            : "border-faint hover:border-red-500"
        }`}
      >
      ...
      <div className="min-w-0 flex-1">
        {editing ? (
          <input
            ...
            className="w-full bg-transparent text-xs text-ink outline-none border-b border-red-500"
          />
        ) : (
          <span
