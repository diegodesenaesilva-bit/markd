...
export function EditorToolbar({ editor, onOpenAskMark, isAskMarkOpen }: EditorToolbarProps) {
    ...
    <div className="sticky top-0 z-20 flex flex-wrap items-center gap-0.5 border-b border-line bg-bg/95 px-2 py-1 backdrop-blur-md">
      ...
      {!isAskMarkOpen && (
        <div className="ml-auto flex items-center gap-1.5">
          <button
            type="button"
            onClick={onOpenAskMark}
            className="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-amber-500 via-purple-600 to-indigo-600 px-3 py-1 text-xs font-semibold text-white shadow-md transition-all hover:opacity-90 active:scale-95"
            title="Abrir Assistente de IA Mark (Ctrl+J)"
          >
