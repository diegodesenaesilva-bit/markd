...
export function AskMarkSidebar({
  ...
  return (
    <aside className="relative flex h-full w-[380px] shrink-0 flex-col border-l border-line bg-bg shadow-2xl z-30 transition-all duration-200">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-line px-4 py-3 bg-panel/50">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-semibold text-ink">Peça ao Mark ✨</h3>
            ...
            {msg.role === "assistant" && (
              <div className="flex items-center gap-2 pt-1 text-[11px] text-faint">
                ...
                {selectedText && onInsertResult && (
                  <button
                    type="button"
                    onClick={() => onInsertResult(msg.text, true)}
                ...
                {onInsertResult && (
                  <button
                    type="button"
                    onClick={() => onInsertResult(msg.text, false)}
