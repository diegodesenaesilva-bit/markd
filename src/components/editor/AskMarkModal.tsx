      ...
      <div className="relative w-full max-w-xl rounded-xl border border-line bg-bg p-5 shadow-2xl transition-all">
        ...
        <div className="flex items-center justify-between border-b border-line pb-3">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-amber-500 to-purple-600 text-white shadow-md">
              <Sparkles size={18} />
            </div>
            <div>
              <h3 className="text-base font-semibold text-ink">Peça ao Mark ✨</h3>
              <p className="text-xs text-faint">Assistente de IA alimentado pelo Qwen 2.5</p>
            </div>
          </div>
          <button
            type="button"
